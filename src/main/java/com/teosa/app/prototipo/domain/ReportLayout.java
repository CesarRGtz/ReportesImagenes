...
public final class ReportLayout {
    ...
    public static final double PAGE_WIDTH = 612.0;
    public static final double PAGE_HEIGHT = 792.0;
    public static final double MARGIN_HORIZONTAL = 50.0;
    public static final double MARGIN_VERTICAL = 45.0;
    public static final double CONTENT_WIDTH = PAGE_WIDTH - (MARGIN_HORIZONTAL * 2.0);
    public static final double CONTENT_HEIGHT = PAGE_HEIGHT - (MARGIN_VERTICAL * 2.0);
    public static final double DOCUMENT_HEADER_HEIGHT = 112.0;
    public static final double GENERAL_DATA_HEIGHT = 135.0;
    public static final double REPORT_TOP_SPACING = 10.0;
    public static final double SECTION_HEADER_HEIGHT = 28.0;
    public static final double PHOTO_SECTION_HEIGHT = 45.0;
    public static final double CATEGORY_TITLE_HEIGHT = 34.0;
    public static final double PHOTO_CELL_PADDING = 8.0;
    public static final double PHOTO_GAP = 14.2; // Aproximadamente 0.5 cm.
    public static final double MAX_PHOTO_WIDTH = CONTENT_WIDTH - (PHOTO_CELL_PADDING * 2.0);
    public static final double PHOTO_CAPTION_HEIGHT = 22.0;
    public static final double PHOTO_SPACING = 8.0;
    public static final double PDF_LAYOUT_SAFETY = 4.0;
    public static final double MAX_PHOTO_ROW_HEIGHT = CONTENT_HEIGHT
            - PHOTO_SECTION_HEIGHT - CATEGORY_TITLE_HEIGHT - PDF_LAYOUT_SAFETY;
    public static final double MIN_PHOTO_WIDTH = 100.0;
    public static final double MIN_PHOTO_RENDER_HEIGHT = 24.0;
    public static final double DEFAULT_PHOTO_WIDTH = MAX_PHOTO_WIDTH;

    private ReportLayout() {
    }

    public static double photoWidthToPercent(double width) {
        return clamp(width / MAX_PHOTO_WIDTH * 100.0,
                MIN_PHOTO_WIDTH / MAX_PHOTO_WIDTH * 100.0, 100.0);
    }

    public static double photoWidthFromPercent(double percentage) {
        double minimum = MIN_PHOTO_WIDTH / MAX_PHOTO_WIDTH * 100.0;
        return MAX_PHOTO_WIDTH * clamp(percentage, minimum, 100.0) / 100.0;
    }

    public static double[] scaleImage(double originalWidth, double originalHeight,
    ...
    public static double estimateDescriptionHeight(String description) {
        return estimateDescriptionHeight(description, MAX_PHOTO_WIDTH);
    }

    public static double estimateDescriptionHeight(String description, double availableWidth) {
    ...
    public static double estimateCategoryTitleHeight(String title) {
        return estimateCategoryTitleHeight(title, 14.0);
    }

    public static double estimateCategoryTitleHeight(String title, double fontSize) {
    ...
    public static double photoCellWidth(double requestedWidth) {
        return Math.min(Math.max(requestedWidth, MIN_PHOTO_WIDTH), MAX_PHOTO_WIDTH);
    }

    public static double estimateBodyHeight(String text) {
    ...
    public static double initialPhotoSpace(String equipmentData, String workDescription) {
    ...
    public static double generalDataHeight(int visibleFieldCount) {
        return Math.max(0, visibleFieldCount) * 27.0;
    }

    public static double estimateDocumentHeaderHeight(TemplateDefinition template) {
    ...
    public static double estimateHeaderTextWidth(TemplateDefinition template, String company) {
    ...
    public static double estimateSectionHeaderHeight(String title) {
    ...
    public static double estimatePhotoSectionHeight(String title) {
